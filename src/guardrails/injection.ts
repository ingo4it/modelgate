...
const PATTERNS: Array<{ id: string; re: RegExp }> = [
  {
    ...
    re: /\b(ignore|disregard|forget|override)\b.{0,30}\b(previous|prior|above|earlier|all)\b.{0,20}\b(instructions?|prompts?|rules?|context)\b/i,
  },
  {
    id: "reveal_system_prompt",
    re: /\b(show|print|reveal|repeat|output)\b.{0,20}\b(system|developer)\b.{0,10}\bprompt\b/i,
  },
  { id: "role_injection", re: /^\s*(system|assistant|developer)\s*:/im },
  { id: "delimiter_break", re: /(<\/?(system|instructions?|context)>|```system|\[\/?INST\])/i },
  {
    id: "exfiltrate",
    re: /\b(base64|rot13|hex)\b.{0,20}\b(the|your|all)\b.{0,20}\b(instructions?|prompt|context)\b/i,
  },
];
